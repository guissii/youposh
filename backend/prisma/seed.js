...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.promoCode.deleteMany();
        ...
        for (const cat of categories) {
            yield prisma.category.create({ data: cat });
        }
        ...
        yield prisma.promoCode.createMany({
            data: [
        ...
        const c1 = yield prisma.customer.create({ data: { name: 'Ahmed Benali', phone: '+212 612 345 678', email: 'ahmed@email.com', city: 'Casablanca', totalOrders: 3, totalSpent: 727 } });
        const c2 = yield prisma.customer.create({ data: { name: 'Fatima Zahra', phone: '+212 661 234 567', email: 'fatima@email.com', city: 'Rabat', totalOrders: 2, totalSpent: 478 } });
        const c3 = yield prisma.customer.create({ data: { name: 'Youssef El Amrani', phone: '+212 655 876 543', email: 'youssef@email.com', city: 'Marrakech', totalOrders: 1, totalSpent: 399 } });
        const allProducts = yield prisma.product.findMany();
        const p = (sku) => allProducts.find(pr => pr.sku === sku);
