...
import {
  getNewProducts as _getNew,
  getBestSellerProducts as _getBest,
  getPromoProducts as _getPromo,
  getPopularProducts as _getPopular,
...
export const getPopularProducts = () => _getPopular(products);
export const getNewProducts = () => _getNew(products);
export const getPromoProducts = () => _getPromo(products);
export const getBestsellers = () => _getBest(products);
