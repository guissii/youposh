...
exports.searchProducts = exports.getBestsellers = exports.getPromoProducts = exports.getNewProducts = exports.getPopularProducts = exports.getProductsByCategory = exports.getProductById = exports.products = exports.categories = void 0;
exports.categories = [
...
exports.products = [
    ...
    {
        id: 10,
        name: 'Support Téléphone Pliable',
        nameAr: 'حامل هاتف قابل للطي',
        price: 59,
        originalPrice: 99,
    ...
    {
        id: 11,
        name: 'Récepteur Bluetooth 5.0',
        nameAr: 'مستقبل بلوتوث 5.0',
        price: 89,
        originalPrice: 149,
...
// ── Re-export logic-based queries for backward compat ──────────
var productLogic_1 = require("@/lib/productLogic");
var getProductById = function (id) { return exports.products.find(function (p) { return p.id === id; }); };
exports.getProductById = getProductById;
var getProductsByCategory = function (slug) { return exports.products.filter(function (p) { return p.category === slug; }); };
exports.getProductsByCategory = getProductsByCategory;
var getPopularProducts = function () { return (0, productLogic_1.getPopularProducts)(exports.products); };
exports.getPopularProducts = getPopularProducts;
var getNewProducts = function () { return (0, productLogic_1.getNewProducts)(exports.products); };
exports.getNewProducts = getNewProducts;
var getPromoProducts = function () { return (0, productLogic_1.getPromoProducts)(exports.products); };
exports.getPromoProducts = getPromoProducts;
var getBestsellers = function () { return (0, productLogic_1.getBestSellerProducts)(exports.products); };
exports.getBestsellers = getBestsellers;
var searchProducts = function (query) {
    var q = query.toLowerCase();
    return exports.products.filter(function (p) {
        var _a;
        return p.name.toLowerCase().includes(q) ||
            p.nameAr.toLowerCase().includes(q) ||
            ((_a = p.tags) === null || _a === void 0 ? void 0 : _a.some(function (t) { return t.toLowerCase().includes(q); }));
    });
};
